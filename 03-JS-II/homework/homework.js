...
function colors(color) {
  ...
  let colorDesc = '';
  if (!color) {
    colorDesc = 'Color not found' ;
  } else {
    switch (color.toLowerCase()) {
      case 'blue':
        colorDesc = 'This is blue';
        break;
      case 'red':
        colorDesc = 'This is red';
        break;
      case 'green':
        colorDesc = 'This is green';
        break;
      case 'orange':
        colorDesc = 'This is orange';
        break;
      default:
        colorDesc = 'Color not found';
        break;
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return num1 > num2 && num1 > num3 && num1 > 0 ? 'Número 1 es mayor y positivo' 
  ...
  if (numero === 1 || numero === 0) {
    ...
    for (let i = 0; i < numero; i++) {
      for (let j = 0; j < numero; j++) {
        if (i * j === numero) {
          // console.log(`Multiplos de ${numero}: ${i} ${j}`);
          esPrimo = false;
        }
      }
    }
  }
  esPrimo === undefined ? esPrimo = true : false ;
  return  esPrimo;
}
